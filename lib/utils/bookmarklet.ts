 ...
 * (Chrome 115+) isolates booklage-origin iframes embedded in 3rd-party
 * pages from the booklage main tab + PiP. The popup opens a top-level
 * booklage tab where IDB and BroadcastChannel work in the {booklage,
 * booklage} partition. Service workers and Storage Access API are also
 * partitioned. The Chrome extension is the only web-platform-clean way
 * to bypass this without a popup.
 *
